...
const Services = () => {
  return (
    <div className="py-20 lg:py-25 bg-[#16161b] text-white">
      <Container>
        <div>
          ...
          <div className="text-center pb-12 lg:pb-18 px-4">
            ...
            <h3 className="text-3xl md:text-4xl py-4 font-bold">Our Services</h3>
            <p className="max-w-[520px] mx-auto text-[#8B9CB7] text-base md:text-lg">
